...
(* OASIS_START *)
(* DO NOT EDIT (digest: 23703fc362510eef0892d4b234ab6d2e) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xen-grant", None);
                           FindlibPackage ("xen-event", None)
                        ];
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\185\193\254\129\218\019\143-\246\159l\215\240o\205\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
