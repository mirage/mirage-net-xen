...
(* OASIS_START *)
(* DO NOT EDIT (digest: 058d822d386ed55fd0efb0ee9dd2fb5c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving", None);
                           ...
                           FindlibPackage ("mirage-net-lwt", None)
                        ];
                   ...
                   {
                      lib_modules =
                        ["Frontend"; "Backend"; "Xenstore"; "S"; "Stats"];
                      lib_pack = true;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "compat";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "netchannel"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-net-xen";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "*\129\0255pr\158.\153\137\007\017\026\250\213\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
