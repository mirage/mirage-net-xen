...
(* OASIS_START *)
(* DO NOT EDIT (digest: fae2663f298b5ae2b479f813c3061c5a) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Frontend"];
                      lib_pack = true;
                      lib_internal_modules = ["Flag"; "ResultM"; "RX"; "TX"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "O\237\147\212{n\235\r\222\025\174\196+\154\140W";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
